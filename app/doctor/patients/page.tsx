      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-medium italic">Clinical demographics and ward admission control.</p>
          </div>
        </div>
      ...
      <Dialog open={isRegOpen} onOpenChange={setIsRegOpen}>
        <DialogContent className="sm:max-w-[550px] rounded-[2.5rem] border-none shadow-2xl p-0 overflow-hidden">
          <div className="bg-primary p-8 text-primary-foreground relative overflow-hidden">
              ...
              <DialogHeader>
                <DialogTitle className="text-3xl font-black italic">Onboard New Patient</DialogTitle>
                <DialogDescription className="text-primary-foreground/80 font-medium italic">Create a new clinical identity in the facility database.</DialogDescription>
              </DialogHeader>
          </div>
          <div className="p-8">
      ...
      <Dialog open={isAdmitOpen} onOpenChange={setIsAdmitOpen}>
        <DialogContent className="sm:max-w-[450px] rounded-[2.5rem] border-none shadow-2xl p-0 overflow-hidden">
           <div className="bg-primary p-8 text-primary-foreground relative overflow-hidden">
              ...
              <DialogHeader>
                <DialogTitle className="text-3xl font-black italic">Ward Admission</DialogTitle>
                <DialogDescription className="text-primary-foreground/80 font-medium italic">Assign a clinical protocol and room for this session.</DialogDescription>
              </DialogHeader>
          </div>
      ...
      <Dialog open={isOrderOpen} onOpenChange={setIsOrderOpen}>
        <DialogContent className="sm:max-w-[450px] rounded-[2.5rem] border-none shadow-2xl p-0 overflow-hidden">
           <div className="bg-primary p-8 text-primary-foreground relative overflow-hidden">
              ...
              <DialogHeader>
                <DialogTitle className="text-3xl font-black italic">Clinical Order</DialogTitle>
                <DialogDescription className="text-primary-foreground/80 font-medium italic">Issue an immediate medication or metric instruction.</DialogDescription>
              </DialogHeader>
          </div>
