    ...
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Welcome back, {user?.username}. Manage clinical prescription queue and dispensing.</p>
        </div>
      </div>
      ...
      <div className="bg-card border rounded-2xl p-6 shadow-sm space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="relative w-64">
            ...
            <Input placeholder="Filter queue..." className="pl-9 rounded-lg" />
          </div>
        </div>
        ...
        {isLoading ? (
          <div className="text-center py-20 flex flex-col items-center gap-4">
            ...
            <p className="text-muted-foreground">Updating dispensing queue...</p>
          </div>
        ) : (
          <PrescriptionQueue 
