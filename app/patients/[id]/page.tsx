              ...
              <div className="pt-6 border-t border-muted">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-2xl">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm font-black">{activeAdmission ? "LIVE SESSION" : "CLOSED SESSION"}</p>
                  </div>
          ...
          {activeAdmission && (
            <Card className="rounded-[2.5rem] border-none shadow-xl shadow-muted/30 overflow-hidden bg-primary text-primary-foreground relative">
              ...
              <CardHeader className="pb-4">
                <CardTitle className="text-xl font-black">Active Ward Context</CardTitle>
              </CardHeader>
          ...
          <Card className="rounded-[2.5rem] border-none shadow-xl shadow-muted/30 overflow-hidden bg-card h-full min-h-[600px]">
            <CardHeader className="bg-muted/5 border-b pb-6 px-8 pt-8 flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription className="font-medium text-xs uppercase tracking-widest mt-1">Immutable chronological care log</CardDescription>
              </div>
              <Button variant="ghost" size="icon" className="rounded-xl" onClick={() => window.print()}><Printer className="h-4 w-4" /></Button>
            </CardHeader>
