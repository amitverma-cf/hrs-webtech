      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-medium">Verified clinical telemetry and biometric logs.</p>
          </div>
        </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-32 space-y-4">
              ...
              <div className="max-w-xs mx-auto">
                ...
                <p className="text-sm text-muted-foreground font-medium mt-1">Bedside telemetry from clinical staff will be automatically synchronized here.</p>
              </div>
            </div>
          )}
        </CardContent>
