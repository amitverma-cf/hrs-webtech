      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-medium">Deterministic care plans and disease-specific treatment logic.</p>
          </div>
        </div>
      ...
      <div className="bg-transparent min-h-[400px]">
        {isLoading ? (
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            {templates.length === 0 && (
              <div className="col-span-2 text-center py-24 text-muted-foreground font-medium bg-muted/20 border-2 border-dashed rounded-[3rem]">
