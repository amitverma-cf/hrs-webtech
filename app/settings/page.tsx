            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground font-medium">Validated Credentials for {user?.fullName || user?.username}</p>
                    </div>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <Card className="rounded-[2.5rem] border-none shadow-xl shadow-muted/30 overflow-hidden bg-card">
                        ...
                        <CardContent className="p-6 space-y-4 text-center">
                            <p className="text-xs text-muted-foreground font-medium">To update your credentials or biometric identity, please contact clinical operations.</p>
